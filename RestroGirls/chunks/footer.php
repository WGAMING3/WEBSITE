<section class="ffooter">
		<footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">123, Lokmanya Nagar, Walmiki Nagar, Latur,</p>
                <p class="grey-text text-lighten-4">Phone : +02382-123456</p>
              </div>
          ...
          <div class="footer-copyright">
            <div class="container">
            © 2020 | 2021 Copyright @ RestroGirls Design By : SHAIKH SADIK
